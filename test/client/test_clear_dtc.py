...
class TestClearDtc(ClientServerTest):
    ...
    def test_clear_dtc_success(self):
        ...
        self.assertEqual(request, "\x14\x12\x34\x56")
        self.conn.fromuserqueue.put("\x54")	# Positive response
    ...
    def test_clear_dtc_all(self):
        request = self.conn.touserqueue.get(timeout=0.2)
        self.assertEqual(request, "\x14\xFF\xFF\xFF")
        self.conn.fromuserqueue.put("\x54")	# Positive response
    ...
    def test_clear_dtc_denied_exception(self):
        self.wait_request_and_respond("\x7F\x14\x31") #Request Out Of Range
    ...
    def test_clear_dtc_invalidservice_exception(self):
        self.wait_request_and_respond("\x00") #Inexistent Service
